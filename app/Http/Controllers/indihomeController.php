...
{
    public function cekIndihome(Request $request)
    {
        ...
        $tokenResponse = Http::withHeaders([
            ...
            'referer' => 'https://www.bukalapak.com/telkom-indihome',
        ...
        $inquiryResponse = Http::withHeaders([
            ...
            'accept-language' => 'en-US,en;q=0.9',
            'priority' => 'u=1, i',
        ])->post("https://api.bukalapak.com/telkom-postpaids/inquiries?access_token={$accessToken}", [
            'customer_number' => $customerNumber
        ]);

        if (!$inquiryResponse->ok()) {
            return response()->json(['error' => 'Gagal melakukan inquiry Tagihan Indihome'], 500);
        }
